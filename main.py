...
is_small = args.small
feature_dict = {
    "if_current_token": args.no_ctoken, "if_prev_token": args.no_ptoken,
    "if_current_pos": args.no_cpos, "if_prev_pos": args.no_ppos,
    "if_current_chunk": args.no_cchunk, "if_prev_chunk": args.no_pchunk
}
